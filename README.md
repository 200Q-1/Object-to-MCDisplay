...
1. 追加したモデルを選択し、サイドバーのアイテムにある[Displayプロパティ](#Displayプロパティパネル)の`+ 新規`をクリックします。  
...
O2MCDパネルの`エクスポート`を押します。もしくは`更新`を押してoutputに表示されたコマンドをコピーします。  
...
チェックボックスにチェックを入れることでアドオンが有効化され、[Displayプロパティパネル](#Displayプロパティパネル)、[プロパティリンクメニュー](#プロパティのリンク)、[Input](#入力/出力)が追加されます。  
<img src="https://github.com/200Q-1/Object-to-MCDisplay/blob/master/image/output.png" width="540">
